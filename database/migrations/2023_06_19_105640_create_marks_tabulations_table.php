...
return new class extends Migration
{
    ...
    {
        Schema::create('marks_tabulations', function (Blueprint $table) {
            $table->id();
            ...
            $table->bigInteger('marks_entry_id');
            $table->decimal('obtained_marks', 18, 2);
    ...
    {
        Schema::dropIfExists('marks_tabulations');
    }
};
