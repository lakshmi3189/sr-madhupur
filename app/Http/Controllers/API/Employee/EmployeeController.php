...
class EmployeeController extends Controller
{
    ...
    public function store(Request $req)
    {
        ...
        try {
            ...
            $file_name = '';
            $uniqid = Str::random(3);
            $username = $this->generateUsername($req['firstName'], $uniqid);
            ...
            $this->_mEmployees->password = Hash::make('123');
            $this->_mEmployees->user_name = $username;
            ...
            return responseMsgs(true, "Successfully Saved", $result, "", "API_3.1", responseTime(), "POST", $req->deviceId ?? "");
        } catch (Exception $e) {
    ...
    public function search(Request $req)
    {
        ...
        try {
            ...
            return responseMsgs(true, $msg, $data1, "API_3.2", "", "146ms", "post",  $req->deviceId ?? "");
        } catch (Exception $e) {
            return responseMsgs(false, $e->getMessage(), $data, "API_3.2", "", "", "post", $req->deviceId ?? "");
        }
    }
    ...
    public function show(Request $req)
    {
        ...
        try {
            ...
            return responseMsgs(true, "", $show, "", "API_3.3", responseTime(), "POST", $req->deviceId ?? "");
        } catch (Exception $e) {
    ...
    public function edit(Request $req)
    {
        ...
        try {
            ...
            return responseMsgs(true, "Successfully Updated", $result, "", "API_3.4", responseTime(), "POST", $req->deviceId ?? "");
        } catch (Exception $e) {
    ...
    public function storeCSV(Request $req)
    {
        ...
        try {
            ...
            if (in_array(strtolower($extension), $valid_extension)) {
                ...
                if ($fileSize <= $maxFileSize) {
                    ...
                    foreach ($importData_arr as $importData) {
                        ...
                        $basicData = array(
                            "emp_no" => $importData[0],
                            "highest_qualification" => $importData[1],
                            "total_work_experience" => $importData[2],
                            ...
                            "designation" => $importData[16],
                            "gender_name" => $importData[17],
                            "account_title" => $importData[18],
                            ...
                            "employee_type_name" => $importData[26],
                            "shift" => $importData[27],
                        ...
                        if (!$duplicateData) {
                            ...
                            throw new Exception("Employee Already Existing");
                        }
                        // return "OK2";die; 
            ...
            return responseMsgs(true, "Successfully Uploaded", $data, "", "API_3.7", responseTime(), "POST", $req->deviceId ?? "");
        } catch (Exception $e) {
    ...
    function generateUsername($fullName, $uiniqId)
    {
        $nameParts = explode(' ', $fullName);
        $firstName = $nameParts[0];
        // $lastName = $nameParts[1];
        // $uiniqNo = $uiniqId;
        //$username = Str::lower($firstName) . '_'; // first name of the employee
        $username = Str::lower(substr($firstName, 0, 3)) . '_'; // First three letters of father's name
        $username .= Str::lower($uiniqId); // First three letters of father's name
        // $username .= Str::lower(substr($uiniqNo, 0, 3)); // First three letters of father's name
        ...
        try {
            ...
            if ($req['educationDetails'] != "") {
                ...
                foreach ($req['educationDetails'] as $ob) {
                    ...
                    // $mEmployeeEducation["emp_tbl_id"] =  $req->id;
                    // $mEmployeeEducation["exam_passed_name"] =  $ob['examPassed'];
                    // $mEmployeeEducation["board_uni_inst"] =  $ob['board'];
                    // $mEmployeeEducation["passing_year"] =  $ob['passingYear'];
                    // $mEmployeeEducation["div_grade_name"] =  $ob['divGrade'];
                    ...
                    // $this->_mEmployeeEducation->update();
                    // $arrEdu[] = $this->_mEmployeeEducation;


                    // $this->_mEmployeeEducation::create($mEmployeeEducation);
    ...
    // Edit Address and Parent Details 
    ...
    public function editAddress(Request $req)
    {
        ...
        try {
            ...
            return responseMsgs(true, "Successfully Updated", $result, "", "API_3.12", responseTime(), "POST", $req->deviceId ?? "");
        } catch (Exception $e) {
            return responseMsgs(false, $e->getMessage(), [], "API_3.12", "", responseTime(), "POST", $req->deviceId ?? "");
        }
    }
    ...
    public function editBank(Request $req)
    {
        ...
        try {
            ...
            $getData->update($metaReqs);
            $result['bankDetails'] = $metaReqs;

            return responseMsgs(true, "Successfully Updated", $result, "", "API_3.13", responseTime(), "POST", $req->deviceId ?? "");
        } catch (Exception $e) {
            return responseMsgs(false, $e->getMessage(), [], "API_3.13", "", responseTime(), "POST", $req->deviceId ?? "");
        }
    }
    ...
    public function getDuplicate1(Request $req)
    {
        ...
        try {
            ...
            if (collect($checkData)->isEmpty())
                throw new Exception("Record Not Found!");
            return responseMsgs(true, "", $checkData, "", "API_3.8", responseTime(), "POST", $req->deviceId ?? "");
        } catch (Exception $e) {
            return responseMsgs(false, $e->getMessage(), [], "API_3.8", "", responseTime(), "POST", $req->deviceId ?? "");
        }
    }
    ...
    public function retrieveAll(Request $req)
    {
        try {
            ...
            return responseMsgsT(true, "View All Records", $list, "API_3.5", $queryTime, responseTime(), "POST", $req->deviceId ?? "");
        } catch (Exception $e) {
     ...
     * | View data
     */
    public function retrieveAllFaculty(Request $req)
    {
        try {
            $getData = $this->_mEmployees->retrieveFaculty();
            $perPage = $req->perPage ? $req->perPage : 10;
            $paginater = $getData->paginate($perPage);
            // if ($paginater == "")
            //     throw new Exception("Data Not Found");
            ...
            $queryTime = collect(DB::getQueryLog())->sum("time");
            return responseMsgsT(true, "View All Records", $list, "API_3.10", $queryTime, responseTime(), "POST", $req->deviceId ?? "");
        } catch (Exception $e) {
    ...
    public function delete(Request $req)
    {
        ...
        try {
            ...
            $queryTime = collect(DB::getQueryLog())->sum("time");
            return responseMsgsT(true, "Changes Done Successfully", $req->status, "API_3.7", $queryTime, responseTime(), "POST", $req->deviceId ?? "");
        } catch (Exception $e) {
            return responseMsgs(false, $e->getMessage(), [], "API_3.7", "", responseTime(), "POST", $req->deviceId ?? "");
        }
    }
    ...
    //             throw new Exception("Record Not Found!");
    //         $queryTime = collect(DB::getQueryLog())->sum("time");
    //         return responseMsgsT(true, "Login Successfully", $data1, "API_4.21", $queryTime, responseTime(), "POST", $req->deviceId ?? "", $token);
    //     } catch (Exception $e) {
    //         return responseMsgsT(false, $e->getMessage(), "API_4.21", "", "", "", "post", "", "");
    //     }
    // }
